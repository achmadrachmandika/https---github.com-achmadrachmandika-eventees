                ...
                <div class="card text-dark card-has-bg click-col"
                    ...
                    <div class="card-img-overlay d-flex flex-column">
                        <div class="card-body">
                            ...
                            <h4 href="#"
                                style="color: <?php echo e($event->kuota < 10 ? 'red' : 'green'); ?>; text-decoration: none;">
...
<section class="ftco-section-3 img"
    style="background-image: url(<?php echo e(asset('images/event/Edit-7.jpg')); ?>); background-size: cover; background-position: center; background-repeat: no-repeat;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Magang KWUJTI\https---github.com-achmadrachmandika-eventees\resources\views/home.blade.php ENDPATH**/ ?>