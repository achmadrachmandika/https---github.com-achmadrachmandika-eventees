        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-10 col-md-8 col-lg-6">
                ...
                <div class="event-details">
                    ...
                    <p class="font-weight-bold">Status: <span class="font-weight-normal"><?php echo e($eventdosen->status); ?></span></p>
                    <p class="font-weight-bold">Harga: <span class="font-weight-normal">Rp. <?php echo e(number_format($eventdosen->harga_dosen, 0, ',', '.')); ?></span></p>
        ...
        document.getElementById('pay-button').onclick = function () {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    kode_event: '<?php echo e($eventdosen->kode_evndsn); ?>',
