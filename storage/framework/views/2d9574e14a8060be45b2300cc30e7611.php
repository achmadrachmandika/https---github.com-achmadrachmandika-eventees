...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label for="nip" class="col-md-4 col-form-label text-md-right"><?php echo e(__('NIM')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                        name="nip" value="<?php echo e(old('nip')); ?>" required autocomplete="nip">
...
<?php endif; ?><?php /**PATH D:\Magang KWUJTI\https---github.com-achmadrachmandika-eventees\resources\views/auth/register-mahasiswa.blade.php ENDPATH**/ ?>