            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="course-item bg-light">
                    ...
                    <div class="text-center p-4 pb-0">
                        <h3 class="mb-0">Rp.<?php echo e(number_format($event->harga, 0, ',', '.')); ?></h3>
                        <div class="mb-3">
                    ...
                    <div class="d-flex border-top">
                        ...
                        <small class="flex-fill text-center border-end py-2"><i
                                class="fa fa-clock text-primary me-2"></i> Rp.<?php echo e(\Carbon\Carbon::parse($event->jam)->format('H:i:s')); ?></small>
...
<?php echo $__env->make('layouts2.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Magang KWUJTI\https---github.com-achmadrachmandika-eventees\resources\views//home.blade.php ENDPATH**/ ?>