            ...
            <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
                <div class="block-18 color-2 align-items-stretch">
                    <div class="text">
                        ...
                        {{-- @if(Auth::check()) --}}
                        {{-- <p><a href="{{ route('donation') }}" class="btn btn-white px-3 py-2 mt-2">Donate Now</a>
                        </p> --}}
                        {{-- @else
                        <p><a href="{{ route('donation') }}" class="btn btn-white px-3 py-2 mt-2" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">Donate Now</a></p>
                        @endif --}}
                    </div>
                </div>
            </div>
...
<section class="ftco-gallery">
    <div class="d-md-flex">
        ...
        <a href="{{asset('images/cause-3.jpg')}}"
            class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate"
        ...
        <a href="{{asset('images/cause-4.jpg')}}"
            class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate"
        ...
        <a href="{{asset('images/cause-5.jpg')}}"
            class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate"
    ...
    <div class="d-md-flex">
        <a href="{{asset('images/cause-6.jpg')}}"
            class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate"
        ...
        <a href="{{asset('images/image_3.jpg')}}"
            class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate"
        ...
        <a href="{{asset('images/image_1.jpg')}}"
            class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate"
        ...
        <a href="{{asset('images/image_2.jpg')}}"
            class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate"
