            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        ...
                        <div class="d-flex border-top">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar text-primary me-2"> Tanggal </i>{{
                                \Carbon\Carbon::parse($eventdosen->tanggal)->format('d-m-Y') }}</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"> Jam </i>{{
                                \Carbon\Carbon::parse($eventdosen->jam)->format('H:i:s') }}</small>
                            <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>{{
                                $eventdosen->kuota }} Pemateri</small>
                        </div>
