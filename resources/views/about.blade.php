        ...
        <div class="row d-flex">
            <div class="col-md-6 d-flex ftco-animate">
                <div class="img img-about align-self-stretch"
                    style="background-image: url({{asset('images/tim_eventees.jpg')}}); width: 100%;"></div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
                <div class="staff">
                    <div class="d-flex mb-4">
                        <div class="img" style="background-image: url({{asset('images/Eka_Eventees.jpeg')}});"></div>
                        <div class="info ml-4">
            ...
            <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
                <div class="staff">
                    <div class="d-flex mb-4">
                        <div class="img" style="background-image: url({{asset('images/Rudi_Eventees.jpeg')}});"></div>
                        <div class="info ml-4">
            ...
            <div class="col-lg-4 d-flex mb-sm-4 ftco-animate">
                <div class="staff">
                    <div class="d-flex mb-4">
                        <div class="img" style="background-image: url({{asset('images/Rafi_Eventees.jpeg')}});"></div>
                        <div class="info ml-4">
